...
module mpi_parallel_mod
  ...
  ! variables for MPI in MLMM added by YKL
  integer, public :: mpi_comm_world2   = 0
  integer, public :: mpi_comm_node     = 0
  integer, public :: mpi_comm_ifreplica= 0
  integer, public :: nproc_world2      = 1
  integer, public :: node_id           = 0
  integer, public :: port_id           = 0
  integer, public :: color_program     = 1
  logical, public :: change_world      = .false.
