...
contains
  ...
  subroutine hm_create_atom(prmtop)
    ...
    do iatom = 1, prmtop%num_atoms
      ...
      call hm_set_mass         (iatom, prmtop%mass         (iatom))
  ...
  subroutine hm_create_ambcrd_coord(crd_in, is_ref)
    ...
    ! local variables
    real(wp)                 :: crd(3,2), atom_coord(3,2)
    ...
    do iatom = 1, natom, 2
      ...
      do i = 1, nr
        if (.not. is_ref) then
          call hm_set_atom_coord   (1, iatom+i-1, atom_coord(1,i) )
          call hm_set_atom_coord   (2, iatom+i-1, atom_coord(2,i) )
          call hm_set_atom_coord   (3, iatom+i-1, atom_coord(3,i) )
        else
          call hm_set_atom_refcoord(1, iatom+i-1, atom_coord(1,i) )
          call hm_set_atom_refcoord(2, iatom+i-1, atom_coord(2,i) )
          call hm_set_atom_refcoord(3, iatom+i-1, atom_coord(3,i) )
        end if
      end do
