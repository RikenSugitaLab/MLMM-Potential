...
contains
  ...
  function hm_atom_no(i)
    ...
    call pr_read(hmu_atom_no, int((i-1)*4,dp), hm_atom_no, 4)
  ...
  function hm_atom_cls_no(i)
    ...
    call pr_read(hmu_atom_cls_no, int((i-1)*4,dp), hm_atom_cls_no, 4)
  ...
  function hm_atom_cls_name(i)
    ...
    call pr_read(hmu_atom_cls_name, int((i-1)*6,dp), hm_atom_cls_name, 6)
  ...
  function hm_atom_name(i)
    ...
    call pr_read(hmu_atom_name, int((i-1)*4,dp), hm_atom_name, 4)
  ...
  function hm_atom_coord(j, i)
    ...
    call pr_read(hmu_atom_coord, int(((i-1)*3+(j-1)),dp) * 8, hm_atom_coord, 8)
  ...
  function hm_atom_refcoord(j, i)
    ...
    call pr_read(hmu_atom_refcoord, int(((i-1)*3+(j-1))*8,dp), &
         hm_atom_refcoord, 8)
  ...
  function hm_atom_velocity(j, i)
    ...
    call pr_read(hmu_atom_velocity, int(((i-1)*3+(j-1))*8,dp), &
         hm_atom_velocity, 8)
  ...
  function hm_charge(i)
    ...
    call pr_read(hmu_charge, int((i-1) * 8,dp), hm_charge, 8)
  ...
  function hm_mass(i)
    ...
    call pr_read(hmu_mass, int((i-1) * 8,dp), hm_mass, 8)
  ...
  function hm_residue_no(i)
    ...
    call pr_read(hmu_residue_no, int((i-1) * 4,dp), hm_residue_no, 4)
  ...
  function hm_residue_name(i)
    ...
    call pr_read(hmu_residue_name, int((i-1) * 6,dp), hm_residue_name, 6)
  ...
  function hm_segment_name(i)
    ...
    call pr_read(hmu_segment_name, int((i-1) * 4,dp), hm_segment_name, 4)
  ...
  function hm_molecule_no(i)
    ...
    call pr_read(hmu_molecule_no, int((i-1) * 4,dp), hm_molecule_no, 4)
  ...
  subroutine hm_set_atom_no(i, no)
    ...
    call pr_write(hmu_atom_no, int((i-1)*4,dp), no, 4)
  ...
  subroutine hm_set_atom_cls_no(i, no)
    ...
    call pr_write(hmu_atom_cls_no, int((i-1)*4,dp), no, 4)
  ...
  subroutine hm_set_atom_cls_name(i, name)
    ...
    tmp = name
    call pr_write(hmu_atom_cls_name, int((i-1)*6,dp), tmp, 6)
  ...
  subroutine hm_set_atom_name(i, name)
    ...
    tmp = name
    call pr_write(hmu_atom_name, int((i-1)*4,dp), tmp, 4)
  ...
  subroutine hm_set_atom_coord(j, i, crd)
    ...
    integer,                 intent(in)    :: j
    integer,                 intent(in)    :: i
    real(wp),                intent(in)    :: crd


    call pr_write(hmu_atom_coord, int(((i-1)*3+(j-1)) * 8,dp), crd, 8)
  ...
  subroutine hm_set_atom_refcoord(j, i, crd)
    ...
    call pr_write(hmu_atom_refcoord, int(((i-1)*3+(j-1)) * 8,dp), crd, 8)
  ...
  subroutine hm_set_atom_velocity(j, i, crd)
    ...
    call pr_write(hmu_atom_velocity, int(((i-1)*3+(j-1)) * 8,dp), crd, 8)
  ...
  subroutine hm_set_charge(i, charge)
    ...
    call pr_write(hmu_charge, int((i-1) * 8,dp), charge, 8)
  ...
  subroutine hm_set_mass(i, mass)
    ...
    call pr_write(hmu_mass, int((i-1) * 8,dp), mass, 8)
  ...
  subroutine hm_set_residue_no(i, no)
    ...
    call pr_write(hmu_residue_no, int((i-1) * 4,dp), no, 4)
  ...
  subroutine hm_set_residue_name(i, name)
    ...
    tmp = name
    call pr_write(hmu_residue_name, int((i-1) * 6,dp), tmp, 6)
  ...
  subroutine hm_set_segment_name(i, name)
    ...
    tmp = name
    call pr_write(hmu_segment_name, int((i-1) * 4,dp), tmp, 4)
  ...
  subroutine hm_set_molecule_no(i, no)
    ...
    call pr_write(hmu_molecule_no, int((i-1) * 4,dp), no, 4)
  ...
  subroutine hm_alloc_bonds(num_bonds)
    ...
    call pr_open(hm_get_work_name('bond_list'), &
         int(num_bonds * 4 * 2,dp), hmu_bond_list)
  ...
  function hm_bond_list(j, i)
    ...
    call pr_read(hmu_bond_list, int(((i-1)*2+(j-1)) * 4,dp), hm_bond_list, 4)
  ...
  subroutine hm_set_bond_list(j, i, idx)
    ...
    call pr_write(hmu_bond_list, int(((i-1)*2+(j-1)) * 4,dp), idx, 4)
  ...
  subroutine hm_alloc_angls(num_angls)
    ...
    call pr_open(hm_get_work_name('angl_list'), &
         int(num_angls * 4 * 3,dp), hmu_angl_list)
  ...
  function hm_angl_list(j, i)
    ...
    call pr_read(hmu_angl_list, int(((i-1)*3+(j-1)) * 4,dp), hm_angl_list, 4)
  ...
  subroutine hm_set_angl_list(j, i, idx)
    ...
    call pr_write(hmu_angl_list, int(((i-1)*3+(j-1)) * 4,dp), idx, 4)
  ...
  subroutine hm_alloc_dihes(num_dihes)
    ...
    call pr_open(hm_get_work_name('dihe_list'), &
         int(num_dihes * 4 * 4,dp), hmu_dihe_list)
  ...
  function hm_dihe_list(j, i)
    ...
    call pr_read(hmu_dihe_list, int(((i-1)*4+(j-1)) * 4,dp), hm_dihe_list, 4)
  ...
  subroutine hm_set_dihe_list(j, i, idx)
    ...
    call pr_write(hmu_dihe_list, int(((i-1)*4+(j-1)) * 4,dp), idx, 4)
  ...
  subroutine hm_alloc_imprs(num_imprs)
    ...
    call pr_open(hm_get_work_name('impr_list'), &
         int(num_imprs * 4 * 4,dp), hmu_impr_list)
  ...
  function hm_impr_list(j, i)
    ...
    call pr_read(hmu_impr_list, int(((i-1)*4+(j-1)) * 4,dp), hm_impr_list, 4)
  ...
  subroutine hm_set_impr_list(j, i, idx)
    ...
    call pr_write(hmu_impr_list, int(((i-1)*4+(j-1)) * 4,dp), idx, 4)
  ...
  subroutine hm_alloc_cmaps(num_cmaps)
    ...
    call pr_open(hm_get_work_name('cmap_list'), &
         int(num_cmaps * 4 * 8,dp), hmu_cmap_list)
  ...
  function hm_cmap_list(j, i)
    ...
    call pr_read(hmu_cmap_list, int(((i-1)*8+(j-1)) * 4,dp), hm_cmap_list, 4)
  ...
  subroutine hm_set_cmap_list(j, i, idx)
    ...
    call pr_write(hmu_cmap_list, int(((i-1)*8+(j-1)) * 4,dp), idx, 4)
  ...
  subroutine hm_alloc_water_list(num_waters, water_atom)
    ...
    call pr_open(hm_get_work_name('water_list'), &
         int(num_waters * 4 * water_atom,dp), hmu_water_list)
  ...
  function hm_water_list(j, i)
    ...
    call pr_read(hmu_water_list, int(((i-1)*3+(j-1)) * 4,dp), hm_water_list, 4)
  ...
  subroutine hm_set_water_list(j, i, idx)
    ...
    call pr_write(hmu_water_list, int(((i-1)*3+(j-1)) * 4,dp), idx, 4)
  ...
  subroutine hm_alloc_solute_list(num_solutes)
    ...
    call pr_open(hm_get_work_name('solute_list'), &
         int(num_solutes * 4,dp), hmu_solute_list)
  ...
  function hm_solute_list(i)
    ...
    call pr_read(hmu_solute_list, int((i-1) * 4,dp), hm_solute_list, 4)
  ...
  subroutine hm_set_solute_list(i, idx)
    ...
    call pr_write(hmu_solute_list, int((i-1) * 4,dp), idx, 4)
  ...
  subroutine hm_alloc_solute_list_inv(num_atoms)
    ...
    call pr_open(hm_get_work_name('solute_list_inv'), &
         int(num_atoms * 4,dp), hmu_solute_list_inv)
  ...
  function hm_solute_list_inv(i)
    ...
    call pr_read(hmu_solute_list_inv, int((i-1) * 4,dp), hm_solute_list_inv, 4)
  ...
  subroutine hm_set_solute_list_inv(i, idx)
    ...
    call pr_write(hmu_solute_list_inv, int((i-1) * 4,dp), idx, 4)
  ...
  function hm_solute(i)
    ...
    call pr_read(hmu_solute, int(i-1,dp), flag, 1)
    hm_solute = flag > 0
  ...
  subroutine hm_set_solute(i, flag)
    ...
    call pr_write(hmu_solute, int(i-1,dp), iflag, 1)
  ...
  subroutine hm_alloc_duplicate(num_atoms)
    ...
    call pr_open(hm_get_work_name('duplicate'), &
         int(num_atoms * 4,dp), hmu_duplicate)
  ...
  function hm_duplicate(i)
    ...
    call pr_read(hmu_duplicate, int((i-1) * 4,dp), hm_duplicate, 4)
  ...
  subroutine hm_set_duplicate(i, dup)
    ...
    call pr_write(hmu_duplicate, int((i-1) * 4,dp), dup, 4)
  ...
  subroutine hm_alloc_H_index(num_atoms)
    ...
    call pr_open(hm_get_work_name('H_index'), &
         int(num_atoms * 4 * 8,dp), hmu_H_index)
  ...
  function hm_H_index(j, i)
    ...
    call pr_read(hmu_H_index, int(((i-1)*8+(j-1)) * 4,dp), hm_H_index, 4)
  ...
  subroutine hm_set_H_index(j, i, idx)
    ...
    call pr_write(hmu_H_index, int(((i-1)*8+(j-1)) * 4,dp), idx, 4)
  ...
  subroutine hm_alloc_selatoms(num_sels)
    ...
    call pr_open(hm_get_work_name('selatoms'//ssel), &
         int(num_sels * 4,dp), hmu_selatoms(isel))
  ...
  function hm_selatoms(i, isel)
    ...
    call pr_read(hmu_selatoms(isel), int((i-1)*4,dp), hm_selatoms, 4)
  ...
  subroutine hm_set_selatoms(i, isel, idx)
    ...
    call pr_write(hmu_selatoms(isel), int((i-1)*4,dp), idx, 4)
